...
tokenizer = Wav2Vec2CTCTokenizer("english.json", unk_token="[UNK]", pad_token="[PAD]", word_delimiter_token="|")
processor = Wav2Vec2BertProcessor(feature_extractor=feature_extractor, tokenizer=tokenizer)

ds = DatasetDict()
ds["train"] = load_dataset(DATASET_NAME, "en_us", split="train+validation")
ds["test"]  = load_dataset(DATASET_NAME, "en_us", split="test")
